  ...
  <div id="wrapper">
    <div style="  display:flex;flex-wrap:nowrap;justify-content:flex-end;height:30px;width:100vw;">
      ...
      <div style="display:flex;justify-content:flex-end;align-items:center;width:auto;height:100%">
        ...
        <div style="width:40px;height:100%;display:flex;justify-content:center;align-items:center;"
             v-on:click="close()">
          <div style="width:40px;height:50%;display:flex;justify-content:center;align-items:center;">
...
export default {
  ...
  methods: {
    ...
    mouseOver () { this.active = 'background-color: #cccccc'; },
    mouseLeave () { this.active = 'background-color: transparent'; },
  }
};
</script>
