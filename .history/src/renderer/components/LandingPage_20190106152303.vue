    ...
    <div style="  display:flex;flex-wrap:nowrap;justify-content:flex-end;height:30px;width:100vw;">
      ...
      <div style="display:flex;justify-content:flex-end;align-items:center;width:auto;height:100%">
        ...
        <div :id="closeactive ?'CLOSEmouseOver':'CLOSEmouseLeave'"
          ...
          <div style="width:40px;height:40%;display:flex;justify-content:center;align-items:center;">
            <img :src="closeactive ? close_buttom_on : close_buttom_off"
                 alt="close"
                 height="100%">
          </div>
        </div>
...
import close_buttom_on: require('~@/assets/close-checked.png'),
import close_buttom_off: require('~@/assets/close.png'),
export default {
  name: "landing-page",
  components: {
    SystemInformation
  ...
  data () {
    return {
      ...
      closeactive: 0,
      close_buttom_on: require('~@/assets/close-checked.png'),
      close_buttom_off: require('~@/assets/close.png'),
    }
  },
