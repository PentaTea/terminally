...
export default {
  ...
  data () {
    return {
      ...
      closeactive: 0,
      picUrlOn: require('@/assets/close-checked.png'),
      picUrlOff: require('@/assets/close.png'),
      close: picUrlOff,
    }
  },
  ...
  methods: {
    ...
    closeactive (status) {    this.closeactive = status;
      if (status)
        this.close = this.picUrlOff;
      else
        this.close = this.picUrlOn;
    }
  }
};
</script>
