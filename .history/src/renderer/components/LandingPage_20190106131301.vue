...
export default {
  ...
  data: {
    active: 'background-color: transparent;width:40px;height:40%;display:flex;justify-content:center;align-items:center;'
  },
  methods: {
    open (link) {
    ...
    mouseOver () { this.active = 'background-color: #cccccc;width:40px;height:40%;display:flex;justify-content:center;align-items:center;'; },
    mouseLeave () { this.active = 'background-color: transparent;width:40px;height:40%;display:flex;justify-content:center;align-items:center;'; },
  }
};
</script>
