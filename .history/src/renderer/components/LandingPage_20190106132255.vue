<template>
  <div id="wrapper">
    ...
    <main>
      <div class="left-side">
        <span class="titlesize">Welcome to your terminally!</span>
...
export default {
  ...
  data: {
    active: 'width:40px;height:100%;display:flex;justify-content:center;align-items:center;'
  },
  methods: {
    open (link) {
...
#mouseOver{ this.active = 'background-color: #cccccc;width:40px;height:100%;display:flex;justify-content:center;align-items:center;'; },
#mouseLeave{ this.active = 'background-color: transparent;width:40px;height:100%;display:flex;justify-content:center;align-items:center;'; },
main {
  display: flex;
